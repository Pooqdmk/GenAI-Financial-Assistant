...
export default function Bot() {
      ...
      setConversations(
        conversations.map((chat) =>
          chat.id === currentChatId
            ? {
                ...chat,
                messages: [...chat.messages, { text: "Processing your request...", sender: "bot", timestamp: new Date().toLocaleTimeString() }],
              }
            : chat
        )
      );
  ...
  return (
    <div style={{ display: "flex", height: "100vh" }}>
      <div style={{ width: "25%", backgroundColor: "#2D3748", color: "white", padding: "20px" }}>
        <button
          onClick={startNewChat}
          style={{ backgroundColor: "#4A5568", padding: "10px", borderRadius: "5px", marginBottom: "15px", cursor: "pointer", color: "white", border: "none" }}
        >
          + New Chat
        </button>
        <h2>Chat History</h2>
        <div style={{ marginTop: "10px", overflowY: "auto", maxHeight: "70vh" }}>
          {conversations.map((chat) => (
            <div
              ...
              style={{ padding: "10px", margin: "5px 0", backgroundColor: currentChatId === chat.id ? "#4A5568" : "#718096", cursor: "pointer", borderRadius: "5px" }}
            >
      ...
      <div style={{ width: "75%", backgroundColor: "#F7FAFC", display: "flex", flexDirection: "column" }}>
        <div style={{ backgroundColor: "#4A5568", color: "white", padding: "10px", textAlign: "center" }}>AI Financial Assistant</div>
